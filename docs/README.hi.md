...
- **पंक्ति 2** — आपके **कॉन्टेक्स्ट विंडो**, **5-घंटे** रेट लिमिट, और **7-दिन** रेट लिमिट के लिए रंगीन उपयोग बार, साथ ही पे-एज़-यू-गो खर्च के लिए एक वैकल्पिक **ओवरएज** बार, प्रत्येक के साथ यह दर्शाने वाला काउंटडाउन कि यह कब रीसेट होगा।

बार भरते-भरते 🟢 हरे → 🟡 पीले → 🔴 लाल हो जाते हैं, ताकि आप एक नज़र में देख सकें कि आपके पास कितनी हेडरूम बची है।

कुछ अतिरिक्त सुविधाएँ मुख्य बार्स से आगे उपयोग प्रबंधित करने में मदद करती हैं:
...
- **बर्न-रेट चेतावनी** — जब आपकी वर्तमान गति के अनुमान से कोई लिमिट रीसेट होने से *पहले* ही समाप्त हो जाएगी, तो ccbar उस बार में एक `⚠ <time>` अनुमान जोड़ देता है। डिफ़ॉल्ट रूप से चालू; इसे `ccbar config` में बंद करें।
- **ओवरएज बार** *(ऑप्ट-इन)* — एक अलग `over` बार जो पे-एज़-यू-गो/अतिरिक्त-उपयोग खर्च को ट्रैक करता है, जो 5-घंटे और 7-दिन के प्लान कोटा से स्वतंत्र होता है (एक Pro/Max अकाउंट में दोनों एक साथ हो सकते हैं)। डिफ़ॉल्ट रूप से बंद; इसे `ccbar config` में सक्षम करें।
...
| `CCBAR_SHOW_OVERAGE`| `0`     | पे-एज़-यू-गो/अतिरिक्त-उपयोग ओवरएज बार दिखाएँ (`1`/`0`)।       |
| `CCBAR_SHOW_COST`   | `0`     | पंक्ति 1 पर चालू सेशन कॉस्ट दिखाएँ (`1`/`0`)।                 |
| `CCBAR_SHOW_BURN`   | `1`     | चेतावनी दें (`⚠ <time>`) जब आपकी गति किसी लिमिट को जल्दी समाप्त कर देगी (`1`/`0`)। |
